...
//	}
	...
	public void addLoan(Loans loan) throws ClassNotFoundException, SQLException {
		save("INSERT INTO tbl_book_loans VALUES ("+loan.getBookId()+", "+loan.getBranchId()+", "+loan.getCardNo()+", '"
	+loan.getDateOut()+"', '"+loan.getDueDate()+"', NULL)", null);
		conn.commit();
	}
	...
	public void updateLoanCheckout( Loans loan) throws ClassNotFoundException, SQLException {
		save("UPDATE tbl_book_loans SET dateOut = '"+ loan.getDateOut() +"' WHERE bookId = "+loan.getBookId()
		+" AND branchId = "+loan.getBranchId()+" AND cardNo = "+loan.getCardNo()+" AND dateOut = '"+loan.getDateOut()+"'", null);
		
	}
	public void updateLoanDateIn( Loans loan) throws ClassNotFoundException, SQLException {
		save("UPDATE tbl_book_loans SET dateIn = NULL WHERE bookId = "+loan.getBookId()
		+" AND branchId = "+loan.getBranchId()+" AND cardNo = "+loan.getCardNo()+" AND dateOut = '"+loan.getDateOut()+"'", null);
		
	}
	
	public List<Loans> checkAllLoans(Loans loan)throws SQLException, ClassNotFoundException {
